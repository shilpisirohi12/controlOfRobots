...
class facegoal(ThreadedWebcam,servos):
    def __init__(self):
        super().__init__()
        FPS_SMOOTHING = 0.9
        ...
        minH =   0; minS = 21; minV =   57;
        maxH = 180; maxS = 255; maxV = 138;
    ...
    while True:
        ...
        if len(keypoints)>0:
            print("blob spotted")
            self.pwm.set_pwm(self.LSERVO, 0, math.floor(15 / 20 * 4096))
            self.pwm.set_pwm(self.RSERVO, 0, math.floor(15 / 20 * 4096))
